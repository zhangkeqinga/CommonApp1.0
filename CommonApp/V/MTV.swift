...
protocol MTVDelegate {
    func requestFishData(data : [AnyObject])
 }
...
//                
//                //zkq 
//                self.mtvDelegate?.requestFishData([])
//				return
//			}
...
//                
//                //zkq
//                self.mtvDelegate?.requestFishData(self.data)
//				return
//			}
//            
//			if !isMore {
