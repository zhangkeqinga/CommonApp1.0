...
public extension UIButton {
    ...
    public func setBgImagePress(imageName:UIImage,pressImageName:UIImage){
        setBackgroundImage(imageName, forState: .Normal)
        setBackgroundImage(pressImageName, forState: .Highlighted)
    }
